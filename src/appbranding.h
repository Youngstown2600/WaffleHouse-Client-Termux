...
#define APP_DISPLAY_NAME "WaffleHouse-Client-Termux"
#endif
#ifndef APP_ID
...
#define APP_VERSION_STRING "Build 0.9"
#endif
...
inline QString appEditionDisplayName() { return appDisplayName() + QStringLiteral(" Build 0.9"); }
